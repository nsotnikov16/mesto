...
export default class Card {
    constructor (data, template, isOwner, putLikeRequest, deleteLikeRequest, handleCardClick, confirm) {
        this._data = data;
    ...
    _setEventListeners () {
        this._trashButton.addEventListener('click', () => this._confirm(this.id, this._element));
